            ...
            <div className="register-wrapper">
                ...
                <div className="register-form">
                    <div className="register-form-wrapper">
                        ...
                        <Button className='registerbuttons' onClick={handleSubmit}>Sign Up</Button>
                        <hr className='separator'></hr>
                        <Link to='/login' style={{color: 'aquamarine', textDecoration:'none'}}>Already have an account?</Link>   
                    </div>
                </div>
            </div>
        </div>
